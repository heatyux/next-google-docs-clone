...
const Maker = ({
  ...
  return (
    ...
    >
      <FaCaretDown className="trasnform absolute top-0 left-1/2 h-full -translate-x-1/2 fill-blue-500" />

      <div
        className="absolute top-4 left-1/2 h-screen w-px -translate-x-1/2 scale-x-50 transform bg-blue-500"
        style={{
